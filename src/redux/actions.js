import {SEARCH_NAME , GET_FAVORITES, DELETE_FAV, GET_ALL, ON_CLOSE, RESET_SEARCH, NEXT_PAGE, FIRST_PAGE, PREVIOUS_PAGE, FILTER_POKEMONS, SORT_POKEMONS, CREATE_POKEMON} from "./action-types";

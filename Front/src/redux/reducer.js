import { SEARCH_NAME, DELETE_FAV, GET_ALL, ON_CLOSE, RESET_SEARCH, GET_FAVORITES, NEXT_PAGE, PREVIOUS_PAGE, FIRST_PAGE, FILTER_POKEMONS, SORT_POKEMONS, CREATE_POKEMON} from './action-types';
